    ...
    return (
        <>
            ...
            <Banner
                ...
                subtitulo='Conheça um pouco mais sobre a desenvolvedora do FinanceData'
            ...
            <section className="container sobre_dev">
                ...
                <article className="sobre_dev_resumo">
                    ...
                    <div className="sobre_dev_texto">
                        ...
                        <Link className="link_data_finance" to="/">FinanceData</Link>
        ...
        <section className="container sobre_projeto">
            <h1>Sobre o FinanceData</h1>
            <article className="sobre_projeto_texto">
                <p>O projeto FinanceData foi um trabalho de conclusão do curso de Desenvolvimento Web Front-end promovido pela Reprograma. </p>
                ...
                <p>Espero que as informações do FinanceData possam agregar conhecimento a todas as pessoas que acessarem.</p>
            </article>
